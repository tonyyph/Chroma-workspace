...
The primary audience is visually literate creators and journal users. The product
must feel like a living emotional archive, not a photo grid or music player.

## Cycle-one outcome

An iOS or Android user can complete the loop without an account, cloud service, or
Spotify credential. Music is explicitly provided by a typed mock provider. Saved
Memories default to private and stay on the device.
